 ...
 *
 * The no-argument constructor `OkhslColor()` is hue 0 at full saturation and mid
 * lightness — a deep pink, not red: [hue] is Oklab's hue angle, where sRGB red sits at
 * 29.2°. Note that each model's default is intentionally its space's most natural origin,
