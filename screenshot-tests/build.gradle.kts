...
val readmeGoldens = mapOf(
    ...
    "HsvIndependentPreview" to "hsv-independent",
    "HsvContextualPreview" to "hsv-contextual",
    "HwbIndependentPreview" to "hwb-independent",
    "HwbContextualPreview" to "hwb-contextual",
    "LabIndependentPreview" to "lab-independent",
    "LabContextualPreview" to "lab-contextual",
    "LchIndependentPreview" to "lch-independent",
    "LchContextualPreview" to "lch-contextual",
    "OklabIndependentPreview" to "oklab-independent",
    "OklabContextualPreview" to "oklab-contextual",
    "OkLchIndependentPreview" to "oklch-independent",
    "OkLchContextualPreview" to "oklch-contextual",
